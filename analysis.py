...
def reddit_anal(subreddit_com, word1, word2, word3, word4, word5, word6):
    # Run through all comments and store them in a list.
        ...
        # Use AFINN-111.txt and make a dict with words and
        ...
        # Get sentiment value for each word and calculate the average.
        afinn_score = 0
        ...
        # Convert list to string in order to count the frequencies.
        ...
        return subreddit_comments_list, word_count,
        sentiment_score, prof_score_list,
        profanity_count, prof_score, prof_wordcount
